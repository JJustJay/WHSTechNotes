...
# April 14, 2025
With the recent ban of phone usage and access to social media during school days towards students in Florida, I believe such a ban would be detrimental to not only students, but schools itself..  This is because many students use their phones throughout the day.  This includes chatting with friends, searching up answers for questions, and also being in contact with family incase of an emergency.  Removing such rights for students can be very harmful because what if something dangerous were to occur near school grounds?  With no way to contact any family members, this can make students vulnerable,  which would anger many parents.

If such phone bans were to occur in my school, I can gurantee that the school would be "cooked".  I say this because some students here get angered whenever they are told to hide their phones and pay attention in class.  I feel like this would lead to many fights occurring between students and teachers,  ruining my schools reputation.  Because of such bans,  this would also limit student learning because many students search up questions for certain assignments that they consider confusing.  This phone ban would definitely decrease student productivity.  This is why I believe phone bans can be detrimental.
...
# September 8, 2025
A career that I am investing myself into for the future is robotic engineering.  This career values computer science as it involves coding, which is the heart of robotics.  One example of this is that coding is used to manuever a robot, since without coding, robots wouldn't really be able to do anything.  Coding is a core feature in robotic engineering as it is like the fuel necessary for robotics so that robots can be coded to do many tasks as the coder wishes. In summary, computer science is a necessary factor in robotic engineering as it is the foundation of the career, and without it, the career may not be the same.

# September 15, 2025
For the presidential AI challenge, there are many ways that AI can be used to solve real-world problems.  My idea for using AI to solve a real world problem is by using AI to find new scientific equations or scientific discoveries that can help with creating a renewable energy source.  I believe that energy is hard to get with all of this new technology today.  With the use of AI, it can speed up the process with research, leading to more discoveries being found more quickly.  This idea meets challenge requirements because it involves the usage of AI to be used for a real world problem, which is renewable energy sources.  This idea will impact people by allowing more efficient energy being used for many people in the world.  This is my idea for the presidential AI challenge.
